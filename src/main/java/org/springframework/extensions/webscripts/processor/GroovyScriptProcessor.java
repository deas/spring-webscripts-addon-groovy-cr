...
public class GroovyScriptProcessor extends AbstractScriptProcessor
{
     ...
     */
    private Object executeGroovyScript(InputStream is, Writer out, Map<String, Object> model)
    {
        try
        {
    ...
    {
        return executeGroovyScript(new ByteArrayInputStream(script.getBytes()), null, model);
    }
    ...
    {
    	return executeGroovyScript(scriptContent.getInputStream(), null, model);
    }
