...
public class GroovyTemplateProcessor extends AbstractTemplateProcessor
{
    ...
    public void process(String templatePath, Object model, Writer out)
    {
    	...
    	ScriptContent scriptContent = groovyScriptProcessor.findScript(templatePath);
    ...
    {
    	return (this.groovyScriptProcessor.findScript(templatePath) != null);
    }
